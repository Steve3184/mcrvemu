...
execute if score #val1 rv_data matches ..-1 run scoreboard players operation #val rv_data += #c_msb rv_data
execute unless score #val1 rv_data matches ..-1 if score #val2 rv_data matches ..-1 run scoreboard players operation #val rv_data += #c_msb rv_data