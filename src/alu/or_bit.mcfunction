...
execute if score #t1 rv_data matches 1 run scoreboard players set #t1 rv_data 1
execute if score #t2 rv_data matches 1 run scoreboard players set #t1 rv_data 1
execute if score #t1 rv_data matches 1 run scoreboard players operation #val rv_data += #m rv_data
