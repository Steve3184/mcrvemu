...
scoreboard players set #t1 rv_data 0
execute if score #val1 rv_data matches ..-1 run scoreboard players set #t1 rv_data 1
scoreboard players set #t2 rv_data 0
execute if score #val2 rv_data matches ..-1 run scoreboard players set #t2 rv_data 1

execute unless score #t1 rv_data = #t2 rv_data run scoreboard players operation #val rv_data += #c_msb rv_data