...
execute if score #pmp_fail rv_data matches 1 run scoreboard players set #cause rv_data 5
...
execute if score #width rv_data matches 6 if score #align_check rv_data matches 1 run scoreboard players set #misaligned rv_data 1
execute if score #width rv_data matches 6 if score #align_check rv_data matches 3 run scoreboard players set #misaligned rv_data 1

execute if score #misaligned rv_data matches 1 run function rv:core/mem/load_ram_unaligned
execute if score #misaligned rv_data matches 1 run return 1

function rv:core/mem/load_ram_aligned