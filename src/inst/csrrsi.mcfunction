...
$execute unless score #c0 rv_data matches $(rs1) run scoreboard players set #rs_imm rv_data $(rs1)
$execute unless score #c0 rv_data matches $(rs1) run function rv:core/csr/do_rsi
